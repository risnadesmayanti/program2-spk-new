...
class Welcome extends CI_Controller {
	...
	public function t_kriteria()
	{
		...
		$data['kriteria'] = $this->Kriteria->selectAll()->result_array();
		$data['sort'] = $this->Kriteria->selectAllSort()->result_array();
		$this->load->view('t_kriteria',$data);
		// var_dump($data['rekomendasi']);
		// $this->load->view('t_kriteria');
	}

	public function t_alternatif()
	{
		$this->calculateEigen();
		$t = $this->calculateEigen2();
		$data['alternatif'] = $this->Alternatif->selectAll()->result_array();
		...
		$data['kriteria'] = $this->Kriteria->selectAll()->result_array();
		$data['sort'] = $this->Kriteria->selectAllSort()->result_array();
		$this->load->view('t_alternatif',$data);
		// var_dump($data['rekomendasi']);
		// $this->load->view('t_kriteria');
	}

	public function v_alternatif()
	{
		$this->calculateEigen();
		$t = $this->calculateEigen2();
		$data['alternatif'] = $this->Alternatif->selectAll()->result_array();
