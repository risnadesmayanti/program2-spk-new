		...
		<div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <center>Tambah Alternatif</center> <!-- <small>Statistics Overview</small> -->
                        </h1>
                        ...
                        <p>
                        	Tambahkan Alternatif Desa Tertinggal yang akan dihitung dengan kriteria yang telah ditentukan. Pastikan kolom Nama ALternatif dan Deskripsi ALternatif terisi dengan lengkap. <br> Isikan skala perbandingan antar alternatif untuk setiap kriteria. Pengisian skala perbandingan harus dalam bentuk pecahan.
                        </p>	
                        	</div>
                        </div></center>
	  					...
	  					<form action="" method="post" id="new" accept-charset="utf-8">
	  						<div class="row" style="padding-top: 10px;">
								...
								<div class="col-md-7 form-group">
									<textarea name="deskripsi" class="form-control" placeholder="Deskripsi Alternatif" rows="6"></textarea>
								</div>
