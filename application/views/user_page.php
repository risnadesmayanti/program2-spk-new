...
<head>
	<!-- Page Header -->
	<title>Tugas Besar SPK || USER PAGE</title>
  	<meta charset="utf-8">
						...
						<div class="tab-content">
						    ...
						    <div id="algoritma" class="tab-pane fade" style="padding-top: 20px;">
							    <div class="panel panel-warning">
								  	<div class="panel-heading">
								  	  <h3 class="panel-title"><b>Analythical Hierarcy Process (AHP)</b></h3>
								 	</div>
								  	<div class="panel-body">
								    	<div class="col-md-4">
						    		...
						    		<div class="col-md-12">
						    			...
						    			<div class="col-md-10">
							      			<table class="table">
									    			...
									    			<?php $arr=array('success','danger','warning','info');$i=0;foreach($rekomendasi as $key){?>
									    			    <tr>
									    			    	<td><?php echo $i+1; ?></td>
