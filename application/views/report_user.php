	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        	...
        	<div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="<?php echo site_url('welcome2/') ?>"><i class="fa fa-fw fa-bar-chart-o"></i> Report</a>
                    </li>
	...
	<div class="container-fluid animate-bottom" style="display: none; padding-top: 70px; background-color: #ffffff" id="container">
			...
			<div class="col-lg-12">
				<div class="panel panel-info">
	  				<div class="panel-heading">
	    				<h3 class="panel-title"><i class="fa fa-fw fa-tabel"></i>&nbsp;&nbsp;Tabel Bobot Kriteria</h3>
				  	</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-info">
	  				<div class="panel-heading">
	    				<h3 class="panel-title"><i class="fa fa-fw fa-table"></i>&nbsp;&nbsp;Tabel Peringkat Alternatif</h3>
				  	</div>
	  				<div class="panel-body">
						<div class="tab-content">
							 <div id="rekom" style="padding-top: 20px;">
						    	<div class="row">
						    		<div class="col-md-12">
						    			...
						    			<div class="col-md-10" style="left: 12.5%">
							      			<table class="table">
							      					<th class="warning">Peringkat</th>
